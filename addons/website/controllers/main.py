...
class Website(Home):
    ...
    def theme_customize_get(self, xml_ids):
        ...
        return {
            ...
            'names': {view.key: view.name for view in views},  # FIXME is this still useful ?
        }
    ...
    def theme_customize(self, enable=None, disable=None):
        ...
        Params:
            enable (str[]|None): List of views' keys to enable
            disable (str[]|None): List of views' keys to disable
        """
