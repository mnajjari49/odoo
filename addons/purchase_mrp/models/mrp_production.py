...
class MrpProduction(models.Model):
    ...
    mto_purchase_order_count = fields.Integer("Count of generated PO", compute='_compute_mto_purchase_order_count', store=True,
    ...
    def _compute_mto_purchase_order_count(self):
        for production in self:
            production.mto_purchase_order_count = len(production.procurement_group_id.stock_move_ids.created_purchase_line_id.order_id)
