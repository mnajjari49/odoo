...
var ProductScreenWidget = ScreenWidget.extend({
    ...
    start: function(){ 
        ...
        this.actionpad.mount(this.$('.placeholder-ActionpadWidget')[0]);

        this.numpad = new NumpadWidget(null, { pos: this.pos });
        this.numpad.mount(this.$('.placeholder-NumpadWidget')[0]);
        ...
        this.orderWidget.mount(this.$('.placeholder-OrderWidget')[0]);
        ...
        this.productsWidget.mount(this.$('.rightpane.ProductsWidget')[0]);
