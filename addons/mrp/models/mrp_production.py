...
class MrpProduction(models.Model):
    ...
    mto_mrp_production_child_count = fields.Integer("Number of generated MO", compute='_compute_mto_mrp_production_child_count', store=True)
    mto_mrp_production_source_count = fields.Integer("Number of source MO", compute='_compute_mto_mrp_production_source_count', store=True)

    @api.depends('procurement_group_id.stock_move_ids.created_production_id')
    def _compute_mto_mrp_production_child_count(self):
        for production in self:
            production.mto_mrp_production_child_count = len(production.procurement_group_id.stock_move_ids.created_production_id)

    @api.depends('move_dest_ids.group_id.mrp_production_id')
    def _compute_mto_mrp_production_source_count(self):
        for production in self:
            production.mto_mrp_production_source_count = len(production.move_dest_ids.group_id.mrp_production_id)
    ...
    def action_view_mto_mrp_production_childs(self):
        self.ensure_one()
    ...
    def action_view_mto_mrp_production_sources(self):
        self.ensure_one()
