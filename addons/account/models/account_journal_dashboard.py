...
class account_journal(models.Model):
    ...
    def _get_bar_graph_select_query(self):
        ...
        return ('''
            SELECT
                SUM((CASE WHEN move.move_type IN %(purchase_types)s THEN -1 else 1 END) * line.amount_residual) AS total,
    ...
    def get_journal_dashboard_datas(self):
        ...
        #TODO need to check if all invoices are in the same currency than the journal!!!!
            ...
            self.env['account.move'].flush(['amount_residual', 'currency_id', 'move_type', 'invoice_date', 'company_id', 'journal_id', 'date', 'state', 'invoice_payment_state'])
    ...
    def open_action(self):
        ...
        domain_type_field = action['res_model'] == 'account.move.line' and 'move_id.move_type' or 'type' # The model can be either account.move or account.move.line
