...
class account_payment(models.Model):
    ...
    state = fields.Selection([('draft', 'Draft'), ('posted', 'Validated'), ('sent', 'Sent'), ('reconciled', 'Reconciled'), ('cancelled', 'Cancelled'), ('from_invoicing', 'From Invoicing')], readonly=True, default='draft', copy=False, string="Status")
