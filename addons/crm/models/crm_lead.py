...
class Lead(models.Model):
    ...
    date_open = fields.Datetime(
        'Assignation Date', compute='_compute_date_open', readonly=True, store=True)
    ...
    title = fields.Many2one('res.partner.title', string='Title', compute="_compute_partner_id_values", store=True, readonly=False)
    email_from = fields.Char('Email', tracking=40, index=True, compute="_compute_partner_id_values", store=True, readonly=False)
    ...
    def _compute_partner_id_values(self):
        ...
        for lead in self:
            lead.update(self._prepare_partner_values(lead.partner_id))
    ...
    def _convert_opportunity_data(self, customer, team_id=False):
        ...
        upd_values = {}
        # if customer:
        #     upd_values.update(self._prepare_partner_values(customer))
