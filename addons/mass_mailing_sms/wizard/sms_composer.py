...
class SMSComposer(models.TransientModel):
    ...
    def _prepare_mass_sms_trace_values(self, record, sms_values):
        ...
        if sms_values['state'] == 'error':
            ...
            if sms_values['error_code'] == 'sms_duplicate':
                trace_values['failure_type'] = 'sms_duplicate'
            elif sms_values['error_code'] == 'sms_blacklist':
                trace_values['failure_type'] = 'sms_blacklist'
        else:
