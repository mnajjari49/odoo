...
class HrExpense(models.Model):
    ...
    quantity = fields.Uom(required=True, readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, uom_field='product_uom_id', default=1)
