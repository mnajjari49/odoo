...
class MrpProduction(models.Model):
    ...
    mto_sale_order_count = fields.Integer("Count of Source SO", compute='_compute_mto_sale_order_count',
    ...
    def _compute_mto_sale_order_count(self):
        for production in self:
            production.mto_sale_order_count = len(production.move_dest_ids.group_id.sale_id)
