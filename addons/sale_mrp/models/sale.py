...
class SaleOrder(models.Model):
    ...
    mto_mrp_production_count = fields.Integer("Count of MO generated", compute='_compute_mto_mrp_production_count',
                                              store=True, groups='mrp.group_mrp_user')

    @api.depends('procurement_group_id.stock_move_ids.created_production_id')
    def _compute_mto_mrp_production_count(self):
        for sale in self:
            sale.mto_mrp_production_count = len(sale.procurement_group_id.stock_move_ids.created_production_id)

    def action_view_mto_mrp_production(self):
        self.ensure_one()
