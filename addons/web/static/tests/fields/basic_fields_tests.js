...
QUnit.module('basic_fields', {
    ...
    QUnit.test('Daterange widget dropdown should disappear on scrolling outside of it', async function (assert) {
        assert.expect(2);
        ...
        assert.isVisible($('.daterangepicker:first'), "date range picker should be closed");
