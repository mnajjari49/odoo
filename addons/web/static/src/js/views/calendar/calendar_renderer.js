...
return AbstractRenderer.extend({
     ...
     */
    _render: function () {
        var calendarElement = this.calendarElement;
        var fc_view = calendarElement.querySelector('.fc-view');
     ...
     * Note: it's a manual fix for scrollTime the normal way don't work because
     * we render the calendar without any parent size FullCalendar can't calculate
