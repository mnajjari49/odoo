...
class Channel(models.Model):
    ...
    nbr_presentation = fields.Integer('Presentations', compute='_compute_slides_statistics', store=True, pre_compute=False)
    nbr_document = fields.Integer('Documents', compute='_compute_slides_statistics', store=True, pre_compute=False)
    nbr_video = fields.Integer('Videos', compute='_compute_slides_statistics', store=True, pre_compute=False)
    nbr_infographic = fields.Integer('Infographics', compute='_compute_slides_statistics', store=True, pre_compute=False)
    nbr_webpage = fields.Integer("Webpages", compute='_compute_slides_statistics', store=True, pre_compute=False)
    nbr_quiz = fields.Integer("Number of Quizs", compute='_compute_slides_statistics', store=True, pre_compute=False)
    total_slides = fields.Integer('Content', compute='_compute_slides_statistics', store=True, pre_compute=False)
    total_views = fields.Integer('Visits', compute='_compute_slides_statistics', store=True, pre_compute=False)
    total_votes = fields.Integer('Votes', compute='_compute_slides_statistics', store=True, pre_compute=False)
    total_time = fields.Float('Duration', compute='_compute_slides_statistics', digits=(10, 2), store=True, pre_compute=False)
