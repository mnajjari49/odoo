...
class Project(models.Model):
    ...
    is_template = fields.Boolean('Is a template', default=False, copy=False, help='Make this project a template for others')
    ...
    def create(self, vals):
        ...
        if project.privacy_visibility == 'portal' and project.partner_id and project.is_template is False:
